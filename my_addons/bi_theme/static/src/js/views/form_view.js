odoo.define('bi_theme.FormView', function (require) {
    "use strict";

    var config = require('web.config');
    var FormRenderingEngineMobile = require('bi_theme.FormRenderingEngineMobile');
...
odoo.define('bi_theme.FormRenderingEngine', function (require) {
    "use strict";
...
odoo.define('bi_theme.FormRenderingEngineMobile', function (require) {
    "use strict";
